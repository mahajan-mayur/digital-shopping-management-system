 ...
 * @author Mahaj
 */
public class MyOrderReviewItemPane extends javax.swing.JPanel {
     ...
     */
    public MyOrderReviewItemPane() {
        initComponents();
    }

    public MyOrderReviewItemPane(int serialNo, OrderItem orderItem) {
    ...
    private void showContent() {
        ...
        this.itemNameLbl.setText(this.orderItem.getItem().getName());
        this.itemCountLbl.setText(this.orderItem.getItemCount().toString());
        this.priceLbl.setText(String.format("%.2f", this.orderItem.getPrice()));
        this.totalPriceLbl.setText(String.format("%.2f", this.orderItem.getItemCount() * this.orderItem.getPrice()));
    }
}
